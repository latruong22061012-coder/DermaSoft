...
class LichHenController extends ApiController
{
    ...
    public function getByStatus(): void
    {
        ...
        if (!$status || !in_array((int)$status, [1, 2, 3, 4])) {
            $this->error('Trạng thái không hợp lệ. Phải là 1-4', null, 400);
        }
    ...
    public function updateStatus(): void
    {
        ...
        if (!in_array((int)$data['status'], [1, 2, 3, 4])) {
            $this->error('Trạng thái không hợp lệ. Phải là 1-4', null, 400);
        }
     ...
     * Xác nhận lịch hẹn (trạng thái = 2)
     * Windows App gọi
     */
    ...
    public function cancel(): void
    {
        ...
        // Chỉ được hủy lịch đang chờ xác nhận (TrangThai = 1)
        if ((int)$appointment['TrangThai'] !== 1) {
