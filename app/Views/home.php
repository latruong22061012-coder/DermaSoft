...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm transition-all" id="mainNav">
        <div class="container-fluid px-4 px-lg-5">
            <a class="navbar-brand logo-wrapper" href="#">
                <img src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>public/assets/images/logo.png" alt="DramaSoft" class="img-fluid logo-img">
            </a>
    ...
    <section id="home" class="mt-5 pt-5">
        <div class="container-fluid p-0 overflow-hidden" data-aos="fade-in" data-aos-duration="1500">
            <div class="image-wrapper hover-zoom-slow">
                <img src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>public/assets/images/banner.png" alt="DramaSoft - Nâng tầm vẻ đẹp chuẩn y khoa" class="w-100 img-fluid">
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center mb-5" data-aos="fade-up">
                ...
                <div class="col-lg-6">
                    <div class="image-wrapper rounded-4 overflow-hidden shadow-lg hover-zoom">
                        <img src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>public/assets/images/welcome3.png" alt="Lễ tân DramaSoft" class="w-100 img-fluid">
                    </div>
                </div>
            </div>
    ...
    <section id="products" class="py-5">
        <div class="container py-5">
            <div class="row align-items-center" data-aos="fade-up">
                ...
                <div class="col-lg-6">
                    <div class="image-wrapper rounded-4 overflow-hidden shadow-lg hover-zoom">
                        <img src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>public/assets/images/Product.png" alt="Khu vực trưng bày sản phẩm DramaSoft" class="w-100 img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="booking" class="py-5 bg-light position-relative">
        <div class="container py-5 position-relative z-1">
            <div class="row justify-content-center" data-aos="fade-up">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="mb-5 text-muted fs-5">Sau khi đặt lịch, chuyên viên tư vấn của DramaSoft sẽ liên hệ xác nhận trong vòng 30 phút.</p>
        ...
        <div class="container mt-5 pt-3" data-aos="fade-up">
            <div class="image-wrapper rounded-4 overflow-hidden shadow-lg hover-zoom">
                <img src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>public/assets/images/footer.png" alt="DramaSoft - Trải nghiệm trọn vẹn" class="w-100 img-fluid">
            </div>
        </div>
    </section>
    ...
    <footer class="py-5 bg-white border-top">
        <div class="container">
            <div class="row g-4 justify-content-between mb-4">
                <div class="col-lg-5">
                    <img src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>public/assets/images/logo.png" alt="DramaSoft" class="img-fluid mb-4" style="height: 45px;">
