                        ...
                        <div class="tab-pane fade" id="v-pills-appointments" role="tabpanel" aria-labelledby="v-pills-appointments-tab">
                            ...
                            <div class="row g-3 mb-5">
                                <?php foreach ($upcomingAppointments as $appt):
                                    ...
                                    $statusClass = $trangThai === 2 ? 'status-confirmed' : 'status-pending';
                                    $statusLabel = $trangThai === 2 ? 'Đã xác nhận' : 'Chờ xác nhận';
                            ...
                            <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 profile-surface-card">
                                <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Cập nhật thông tin để nhận nhắc lịch, ưu đãi và chăm sóc phù hợp từ DramaSoft.</p>
                                    </div>
