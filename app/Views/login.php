                        ...
                        <div class="row g-0">
                            <div class="col-lg-7">
                                <div class="card-body p-md-5">
                                    ...
                                    <p class="auth-hint">Chào mừng bạn quay lại DramaSoft. Vui lòng xác thực số điện thoại để tiếp tục.</p>
                            ...
                            <div class="col-lg-5 auth-brand-box">
                                <div class="h-100 d-flex flex-column justify-content-center p-4 p-md-5 auth-brand-content">
                                    <img src="<?= defined('BASE_URL') ? BASE_URL : '/' ?>public/assets/images/logo.png" alt="DramaSoft" class="mb-4 auth-brand-logo">
        ...
        formRegister.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    showAlert('Thành công', 'Bạn vừa đăng ký tài khoản DramaSoft thành công. Email xác nhận đã được gửi đến ' + emailVal, 'success');
